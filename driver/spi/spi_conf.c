...
SPI_HandleTypeDef h_spi2 = {
    .Instance = SPI2,
};

SPI_HandleTypeDef h_spi3 = {
    .Instance = SPI3,
};

SPI_HandleTypeDef h_spi4 = {
    .Instance = SPI4,
};

SPI_HandleTypeDef h_spi5 = {
    .Instance = SPI5,
};

SPI_HandleTypeDef h_spi6 = {
    .Instance = SPI6,
};
...
uint8_t spi_full_duplex_trans_byte(SPI_HandleTypeDef* h_spix, uint8_t byte)
{
    ...
    *((__IO uint8_t*) & h_spix->Instance->TXDR) = (byte);
    while ((h_spix->Instance->SR & SPI_FLAG_RXNE) != SPI_FLAG_RXNE);
    return h_spix->Instance->RXDR;
}
